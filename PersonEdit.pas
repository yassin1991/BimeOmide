...
procedure TPersonEditForm.BitBtn1Click(Sender: TObject);
begin
PersonEditForm.Close;
end;
...
PersonEditForm.Close;
 ...
 dbcomponent.DataModule5.PersonUniTable.close;
...
procedure TPersonEditForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
PersonEditForm.CleanupInstance;
PersonEditForm.ClearEdits(PersonEditForm);
end;

procedure TPersonEditForm.ClearEdits(Owner: TWinControl);
var i: integer;
begin
